    ...
    private void btnPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPrimeMouseClicked
     ...
     if(txtAge.getText().compareTo("")==0){
       JOptionPane.showMessageDialog(this, "veuillez saisir votre age");
        ...
        if(Integer.parseInt(txtAge.getText())>20 && cboSexe.getSelectedItem().toString().compareTo("Homme")==0 ){
            prime="vous payez la surprime !!!";
        }
        if(Integer.parseInt(txtAge.getText())<30  && cboSexe.getSelectedItem().toString().compareTo("Femme")==0 || Integer.parseInt(txtAge.getText())>20  && cboSexe.getSelectedItem().toString().compareTo("Femme")==0){
           prime="vous payez la surprime !!!"; 
        }
        if (sldNbAnnees.getValue()>5){
            prime="vous ne payez pas la surprime !!!";
        }
        
      lblPrime.setText(prime);
